            ...
            @if(Session::get('vendor_id'))
                <!-- sidebar-toggle-->
                    <a class="logo-horizontal " href="{{ route('vendor.dashboard') }}">
                        ...
                        <img src="{{asset($setting->logo_jpg)}}" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                    <!-- LOGO -->
            @else
                            ...
                            @if(Session::get('vendor_id'))
                                <div class="dropdown d-md-flex profile-1">
                                    <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="{{ asset($vendor->image) }}" alt="profile-user"
                                                         class="avatar  profile-user brround cover-image">
												</span>
                                        <div class="text-center p-1 d-flex d-lg-none-max">
                                            <h6 class="mb-0" id="profile-heading">{{Session::get('vendor_name')}}<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
