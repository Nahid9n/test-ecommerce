            ...
            <ul class="side-menu">
                <li>
                        ...
                        <ul class="slide-menu">
                            <li class="sub-slide">
                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#">
                                    <span class="sub-side-menu__label">Product Module</span>
                                    <i class="sub-angle fa fa-angle-right"></i>
                                </a>
                                <ul class="sub-slide-menu">
                                    <li><a href="{{ route('product.create') }}" class="sub-slide-item">Add Product</a></li>
                                    <li><a href="{{ route('product.index') }}" class="sub-slide-item">Manage Product</a></li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Advanced UI</a></li>
                            <li><a href="{{route('admin.order.report')}}" class="slide-item">Order Report</a></li>
                            <li><a href="{{route('admin.customer.report')}}" class="slide-item">Customer Report</a></li>
